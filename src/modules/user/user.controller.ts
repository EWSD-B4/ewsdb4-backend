...
class UserController {
  getAllUsers = asyncHandler(async (_req: Request, res: Response) => {
    ...
    res.status(200).json(
      successResponse(users, _req.requestId || 'unknown', {
  ...
  getUserById = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(
      successResponse(user, req.requestId || 'unknown', {
  ...
  createUser = asyncHandler(async (req: Request, res: Response) => {
    ...
    res
      .status(201)
      .json(
        successResponse(user, req.requestId || 'unknown', { message: 'User created successfully' })
      );
  });
  ...
  updateUser = asyncHandler(async (req: Request, res: Response) => {
    ...
    res
      .status(200)
      .json(
        successResponse(user, req.requestId || 'unknown', { message: 'User updated successfully' })
      );
  });
