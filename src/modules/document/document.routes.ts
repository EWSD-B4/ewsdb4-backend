...
router.get('/content/contribution/:contributionId', authenticate, authorize('ADMIN', 'MANAGER', 'GUEST'), documentContentController.getByContributionId);
...
router.get('/content/:contributionFileId', authenticate, authorize('ADMIN', 'MANAGER', 'COORDINATOR', 'STUDENT', 'GUEST'), documentContentController.getByContributionFileId);
