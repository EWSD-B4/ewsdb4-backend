...
import managerRoutes from '@/modules/contribution/manager.routes';
...
router.use('/coordinator/contributions', coordinatorRoutes);
router.use('/manager/contributions', managerRoutes);
